...
const Sidebar = ({ activeTab, setActiveTab, darkMode, setDarkMode, isMobileOpen, setIsMobileOpen }) => {
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 bottom-0 z-50 w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col justify-between transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="p-4 border-t border-slate-100 dark:border-slate-800 space-y-3">
          ...
          <a
            ...
            className="block p-3 rounded-xl bg-gradient-to-r from-teal-900/10 to-emerald-900/10 dark:from-teal-950/40 dark:to-emerald-950/40 border border-teal-200/50 dark:border-teal-800/50 hover:shadow-md transition-all group"
          >
